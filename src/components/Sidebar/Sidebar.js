...
const Sidebar = () => {
    ...
    const resumeURL = 'https://drive.google.com/uc?export=download&id=1KY8jBorPMtAilV1YgjtkH8HhHiSrX5rF';
        ...
        <>
            <nav className="navbar  navbar-expand-lg d-block navbar-dark bg-dark justify-content-sm-start  sidebar-div">
                ...
                <div className={`navbar-collapse bg-dark  flex-col  justify-content-center   mobileMenu ${isOpen ? 'Open' : ''} p-3 p-lg-0  mt-lg-0`} id="navbarSupportedContent">
                    ...
                    <Button variant="info" className="fifth-heading sidebar-download-button d-flex align-self-start" onClick={()=>{window.open(resumeURL )}}><i className="bi bi-download"></i>  &nbsp; Download CV   </Button >
                </div>
            </nav>
