    ...
    return (
        ...
        < Fragment >
            ...
            <div className={overlayClasses.join(" ")}>
                <img src={DesignerOverlay} className="overlay-image" alt="overlay-image" />
            </div>
            {
                !isOverlay &&
                <div className="about-div">
                    <div className="container">
                        <div className="row">
                            <div className="col">
                                <h1 className="section-heading main-heading text-center sec-heading text-center content-heading heading-about-me">About me</h1>
